...
public interface ZeroMapper {
	...
	int selectCustomerInfoYn(@Param("customerEmail") String customerEmail, @Param("customerPw") String customerPw)
			throws Exception;
	...
	// 공지사항 글 작성
	void insertNoticeWrite(BoardDto board) throws Exception;

	void insertNoticeFile(List<TFileDto> fileList) throws Exception;
	...
	// 세션생성 하여 관리자 번호 가져옴
	JoinDto selectAdminInfoYn(@Param("adminYn") String adminYn, @Param("customerEmail") String customerEmail) throws Exception;
